...
void defaultPursuitBehavior(SensorComponent* sensors, BulletRigidBodyComponent* rbc, ShipComponent* ship, IrrlichtComponent* irr, flecs::entity pursuitTarget, f32 dt);
#endif 